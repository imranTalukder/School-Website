...
<body class="backG">
	...
	<marquee behavior="scroll" direction="left" style="color: red; background-color: white">টিম পাকিস্তানের অধিনায়ক হিসেবে ক্রিকেটার ইমরান খান ৪৮টি টেস্টের ১৪টিতে জিতেছিলেন। </marquee>
					...
					<?php
						while($row = $result->fetch_assoc()): ?>
							<tr>
								...
								<td>
									<a href="administration.php?edit=<?php echo $row['id']; ?>" 
